 ...
 */
@Entity
@Table(name = "t_warehouse_backrecord_detail")
@ApiModel("退回记录明细")
public class WarehouseBackrecordDetail extends CMSEntity {
    
    /**
     * 退回编号
     */
    @ApiModelProperty(value = "退回编号", required = false)
    
    @Column(columnDefinition = "退回编号")
