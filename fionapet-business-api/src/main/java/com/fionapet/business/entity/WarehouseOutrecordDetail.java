 ...
 */
@Entity
@Table(name = "t_warehouse_outrecord_detail")
@ApiModel("出库记录明细")
public class WarehouseOutrecordDetail extends CMSEntity {
     ...
     * 出厂价格
     */
    @ApiModelProperty(value = "出厂价格", required = false)
    
    @Column(columnDefinition = "出厂价格")
