 ...
 * @author baiqw
 */
public class AppConfigRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(AppConfigRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/appconfigs";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<AppConfig>> result = (RestResult<List<AppConfig>>)restResult;
...
////        appConfig.set*("*");
//
//        Response response = getBuilder(URL, appConfigRestClient.TOKEN).post(Entity.entity(appConfig, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
