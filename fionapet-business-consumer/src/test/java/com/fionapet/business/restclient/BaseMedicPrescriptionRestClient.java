 ...
 */
public class BaseMedicPrescriptionRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(BaseMedicPrescriptionRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/basemedicprescriptions";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<BaseMedicPrescription>> result = (RestResult<List<BaseMedicPrescription>>)restResult;
                ...
                LOGGER.info("BaseMedicPrescription list:{}", JSON.toJSON(restResult));
            }
        }, URL, BaseMedicPrescriptionRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final BaseMedicPrescription baseMedicPrescription = new BaseMedicPrescription();
////        baseMedicPrescription.set*("*");
//
//        Response response = getBuilder(URL, baseMedicPrescriptionRestClient.TOKEN).post(Entity.entity(baseMedicPrescription, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
