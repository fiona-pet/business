 ...
 */
public class BusinesCateRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(BusinesCateRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/businescates";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<BusinesCate>> result = (RestResult<List<BusinesCate>>)restResult;
                ...
                LOGGER.info("BusinesCate list:{}", JSON.toJSON(restResult));
            }
        }, URL, BusinesCateRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final BusinesCate businesCate = new BusinesCate();
////        businesCate.set*("*");
//
//        Response response = getBuilder(URL, businesCateRestClient.TOKEN).post(Entity.entity(businesCate, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
