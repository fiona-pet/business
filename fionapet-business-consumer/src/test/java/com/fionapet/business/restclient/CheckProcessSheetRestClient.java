 ...
 */
public class CheckProcessSheetRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(CheckProcessSheetRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/checkprocesssheets";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<CheckProcessSheet>> result = (RestResult<List<CheckProcessSheet>>)restResult;
                ...
                LOGGER.info("CheckProcessSheet list:{}", JSON.toJSON(restResult));
            }
        }, URL, CheckProcessSheetRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final CheckProcessSheet checkProcessSheet = new CheckProcessSheet();
////        checkProcessSheet.set*("*");
//
//        Response response = getBuilder(URL, checkProcessSheetRestClient.TOKEN).post(Entity.entity(checkProcessSheet, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
