 ...
 */
public class CheckWarehouseDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(CheckWarehouseDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/checkwarehousedetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<CheckWarehouseDetail>> result = (RestResult<List<CheckWarehouseDetail>>)restResult;
                ...
                LOGGER.info("CheckWarehouseDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, CheckWarehouseDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final CheckWarehouseDetail checkWarehouseDetail = new CheckWarehouseDetail();
////        checkWarehouseDetail.set*("*");
//
//        Response response = getBuilder(URL, checkWarehouseDetailRestClient.TOKEN).post(Entity.entity(checkWarehouseDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
