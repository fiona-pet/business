 ...
 */
public class DictTypeDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(DictTypeDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/dicttypedetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<DictTypeDetail>> result = (RestResult<List<DictTypeDetail>>)restResult;
                ...
                LOGGER.info("DictTypeDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, DictTypeDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final DictTypeDetail dictTypeDetail = new DictTypeDetail();
////        dictTypeDetail.set*("*");
//
//        Response response = getBuilder(URL, dictTypeDetailRestClient.TOKEN).post(Entity.entity(dictTypeDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
