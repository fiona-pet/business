 ...
 */
public class EnterpriseRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(EnterpriseRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/enterprises";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Enterprise>> result = (RestResult<List<Enterprise>>)restResult;
                ...
                LOGGER.info("Enterprise list:{}", JSON.toJSON(restResult));
            }
        }, URL, EnterpriseRestClient.TOKEN);
    }
...
////        enterprise.set*("*");
//
//        Response response = getBuilder(URL, enterpriseRestClient.TOKEN).post(Entity.entity(enterprise, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
