 ...
 */
public class ExpensesExpendRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExpensesExpendRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/expensesexpends";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ExpensesExpend>> result = (RestResult<List<ExpensesExpend>>)restResult;
                ...
                LOGGER.info("ExpensesExpend list:{}", JSON.toJSON(restResult));
            }
        }, URL, ExpensesExpendRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ExpensesExpend expensesExpend = new ExpensesExpend();
////        expensesExpend.set*("*");
//
//        Response response = getBuilder(URL, expensesExpendRestClient.TOKEN).post(Entity.entity(expensesExpend, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
