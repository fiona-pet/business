 ...
 */
public class FinanceSettleAccountsRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(FinanceSettleAccountsRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/financesettleaccountss";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<FinanceSettleAccounts>> result = (RestResult<List<FinanceSettleAccounts>>)restResult;
                ...
                LOGGER.info("FinanceSettleAccounts list:{}", JSON.toJSON(restResult));
            }
        }, URL, FinanceSettleAccountsRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final FinanceSettleAccounts financeSettleAccounts = new FinanceSettleAccounts();
////        financeSettleAccounts.set*("*");
//
//        Response response = getBuilder(URL, financeSettleAccountsRestClient.TOKEN).post(Entity.entity(financeSettleAccounts, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
