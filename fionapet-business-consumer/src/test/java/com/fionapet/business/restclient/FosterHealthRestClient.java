 ...
 */
public class FosterHealthRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(FosterHealthRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/fosterhealths";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<FosterHealth>> result = (RestResult<List<FosterHealth>>)restResult;
                ...
                LOGGER.info("FosterHealth list:{}", JSON.toJSON(restResult));
            }
        }, URL, FosterHealthRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final FosterHealth fosterHealth = new FosterHealth();
////        fosterHealth.set*("*");
//
//        Response response = getBuilder(URL, fosterHealthRestClient.TOKEN).post(Entity.entity(fosterHealth, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
