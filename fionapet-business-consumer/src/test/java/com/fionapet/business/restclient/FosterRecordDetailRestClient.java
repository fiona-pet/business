 ...
 */
public class FosterRecordDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(FosterRecordDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/fosterrecorddetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<FosterRecordDetail>> result = (RestResult<List<FosterRecordDetail>>)restResult;
                ...
                LOGGER.info("FosterRecordDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, FosterRecordDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final FosterRecordDetail fosterRecordDetail = new FosterRecordDetail();
////        fosterRecordDetail.set*("*");
//
//        Response response = getBuilder(URL, fosterRecordDetailRestClient.TOKEN).post(Entity.entity(fosterRecordDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
