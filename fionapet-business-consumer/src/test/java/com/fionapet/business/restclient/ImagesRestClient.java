 ...
 */
public class ImagesRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ImagesRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/imagess";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Images>> result = (RestResult<List<Images>>)restResult;
                ...
                LOGGER.info("Images list:{}", JSON.toJSON(restResult));
            }
        }, URL, ImagesRestClient.TOKEN);
    }
...
////        images.set*("*");
//
//        Response response = getBuilder(URL, imagesRestClient.TOKEN).post(Entity.entity(images, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
