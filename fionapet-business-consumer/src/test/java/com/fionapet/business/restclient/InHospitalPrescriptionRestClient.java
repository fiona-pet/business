 ...
 */
public class InHospitalPrescriptionRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(InHospitalPrescriptionRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/inhospitalprescriptions";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<InHospitalPrescription>> result = (RestResult<List<InHospitalPrescription>>)restResult;
                ...
                LOGGER.info("InHospitalPrescription list:{}", JSON.toJSON(restResult));
            }
        }, URL, InHospitalPrescriptionRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final InHospitalPrescription inHospitalPrescription = new InHospitalPrescription();
////        inHospitalPrescription.set*("*");
//
//        Response response = getBuilder(URL, inHospitalPrescriptionRestClient.TOKEN).post(Entity.entity(inHospitalPrescription, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
