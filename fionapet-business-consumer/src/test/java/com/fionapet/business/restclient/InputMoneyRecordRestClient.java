 ...
 */
public class InputMoneyRecordRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(InputMoneyRecordRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/inputmoneyrecords";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<InputMoneyRecord>> result = (RestResult<List<InputMoneyRecord>>)restResult;
                ...
                LOGGER.info("InputMoneyRecord list:{}", JSON.toJSON(restResult));
            }
        }, URL, InputMoneyRecordRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final InputMoneyRecord inputMoneyRecord = new InputMoneyRecord();
////        inputMoneyRecord.set*("*");
//
//        Response response = getBuilder(URL, inputMoneyRecordRestClient.TOKEN).post(Entity.entity(inputMoneyRecord, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
