 ...
 */
public class InventoryLogRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(InventoryLogRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/inventorylogs";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<InventoryLog>> result = (RestResult<List<InventoryLog>>)restResult;
                ...
                LOGGER.info("InventoryLog list:{}", JSON.toJSON(restResult));
            }
        }, URL, InventoryLogRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final InventoryLog inventoryLog = new InventoryLog();
////        inventoryLog.set*("*");
//
//        Response response = getBuilder(URL, inventoryLogRestClient.TOKEN).post(Entity.entity(inventoryLog, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
