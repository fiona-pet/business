 ...
 */
public class ItemCateRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemCateRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/itemcates";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ItemCate>> result = (RestResult<List<ItemCate>>)restResult;
                ...
                LOGGER.info("ItemCate list:{}", JSON.toJSON(restResult));
            }
        }, URL, ItemCateRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ItemCate itemCate = new ItemCate();
////        itemCate.set*("*");
//
//        Response response = getBuilder(URL, itemCateRestClient.TOKEN).post(Entity.entity(itemCate, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
