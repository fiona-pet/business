 ...
 */
public class ItemCountChangeReasonRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemCountChangeReasonRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/itemcountchangereasons";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ItemCountChangeReason>> result = (RestResult<List<ItemCountChangeReason>>)restResult;
                ...
                LOGGER.info("ItemCountChangeReason list:{}", JSON.toJSON(restResult));
            }
        }, URL, ItemCountChangeReasonRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ItemCountChangeReason itemCountChangeReason = new ItemCountChangeReason();
////        itemCountChangeReason.set*("*");
//
//        Response response = getBuilder(URL, itemCountChangeReasonRestClient.TOKEN).post(Entity.entity(itemCountChangeReason, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
