 ...
 */
public class ItemCountRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemCountRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/itemcounts";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ItemCount>> result = (RestResult<List<ItemCount>>)restResult;
                ...
                LOGGER.info("ItemCount list:{}", JSON.toJSON(restResult));
            }
        }, URL, ItemCountRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ItemCount itemCount = new ItemCount();
////        itemCount.set*("*");
//
//        Response response = getBuilder(URL, itemCountRestClient.TOKEN).post(Entity.entity(itemCount, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
