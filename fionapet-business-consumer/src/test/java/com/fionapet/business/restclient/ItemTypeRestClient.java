 ...
 */
public class ItemTypeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemTypeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/itemtypes";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ItemType>> result = (RestResult<List<ItemType>>)restResult;
                ...
                LOGGER.info("ItemType list:{}", JSON.toJSON(restResult));
            }
        }, URL, ItemTypeRestClient.TOKEN);
    }
...
////        itemType.set*("*");
//
//        Response response = getBuilder(URL, itemTypeRestClient.TOKEN).post(Entity.entity(itemType, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
