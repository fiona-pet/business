 ...
 */
public class ItemtypeSuppliesRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemtypeSuppliesRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/itemtypesuppliess";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ItemtypeSupplies>> result = (RestResult<List<ItemtypeSupplies>>)restResult;
                ...
                LOGGER.info("ItemtypeSupplies list:{}", JSON.toJSON(restResult));
            }
        }, URL, ItemtypeSuppliesRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ItemtypeSupplies itemtypeSupplies = new ItemtypeSupplies();
////        itemtypeSupplies.set*("*");
//
//        Response response = getBuilder(URL, itemtypeSuppliesRestClient.TOKEN).post(Entity.entity(itemtypeSupplies, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
