 ...
 */
public class MedicApplianceRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicApplianceRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicappliances";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicAppliance>> result = (RestResult<List<MedicAppliance>>)restResult;
                ...
                LOGGER.info("MedicAppliance list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicApplianceRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicAppliance medicAppliance = new MedicAppliance();
////        medicAppliance.set*("*");
//
//        Response response = getBuilder(URL, medicApplianceRestClient.TOKEN).post(Entity.entity(medicAppliance, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
