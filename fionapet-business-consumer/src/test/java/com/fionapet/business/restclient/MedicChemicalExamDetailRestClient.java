 ...
 */
public class MedicChemicalExamDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicChemicalExamDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicchemicalexamdetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicChemicalExamDetail>> result = (RestResult<List<MedicChemicalExamDetail>>)restResult;
                ...
                LOGGER.info("MedicChemicalExamDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicChemicalExamDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicChemicalExamDetail medicChemicalExamDetail = new MedicChemicalExamDetail();
////        medicChemicalExamDetail.set*("*");
//
//        Response response = getBuilder(URL, medicChemicalExamDetailRestClient.TOKEN).post(Entity.entity(medicChemicalExamDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
