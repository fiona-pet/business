 ...
 */
public class MedicChemicalExamtypeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicChemicalExamtypeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicchemicalexamtypes";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicChemicalExamtype>> result = (RestResult<List<MedicChemicalExamtype>>)restResult;
                ...
                LOGGER.info("MedicChemicalExamtype list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicChemicalExamtypeRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicChemicalExamtype medicChemicalExamtype = new MedicChemicalExamtype();
////        medicChemicalExamtype.set*("*");
//
//        Response response = getBuilder(URL, medicChemicalExamtypeRestClient.TOKEN).post(Entity.entity(medicChemicalExamtype, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
