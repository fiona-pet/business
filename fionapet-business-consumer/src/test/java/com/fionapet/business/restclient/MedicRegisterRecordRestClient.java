 ...
 */
public class MedicRegisterRecordRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicRegisterRecordRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicregisterrecords";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicRegisterRecord>> result = (RestResult<List<MedicRegisterRecord>>)restResult;
                ...
                LOGGER.info("MedicRegisterRecord list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicRegisterRecordRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicRegisterRecord medicRegisterRecord = new MedicRegisterRecord();
////        medicRegisterRecord.set*("*");
//
//        Response response = getBuilder(URL, medicRegisterRecordRestClient.TOKEN).post(Entity.entity(medicRegisterRecord, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
