 ...
 */
public class MedicSuppliesRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicSuppliesRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicsuppliess";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicSupplies>> result = (RestResult<List<MedicSupplies>>)restResult;
                ...
                LOGGER.info("MedicSupplies list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicSuppliesRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicSupplies medicSupplies = new MedicSupplies();
////        medicSupplies.set*("*");
//
//        Response response = getBuilder(URL, medicSuppliesRestClient.TOKEN).post(Entity.entity(medicSupplies, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
