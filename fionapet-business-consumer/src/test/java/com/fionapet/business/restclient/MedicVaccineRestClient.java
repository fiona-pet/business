 ...
 */
public class MedicVaccineRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicVaccineRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicvaccines";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicVaccine>> result = (RestResult<List<MedicVaccine>>)restResult;
                ...
                LOGGER.info("MedicVaccine list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicVaccineRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicVaccine medicVaccine = new MedicVaccine();
////        medicVaccine.set*("*");
//
//        Response response = getBuilder(URL, medicVaccineRestClient.TOKEN).post(Entity.entity(medicVaccine, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
