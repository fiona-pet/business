 ...
 */
public class MedicVedioExamRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(MedicVedioExamRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/medicvedioexams";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<MedicVedioExam>> result = (RestResult<List<MedicVedioExam>>)restResult;
                ...
                LOGGER.info("MedicVedioExam list:{}", JSON.toJSON(restResult));
            }
        }, URL, MedicVedioExamRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final MedicVedioExam medicVedioExam = new MedicVedioExam();
////        medicVedioExam.set*("*");
//
//        Response response = getBuilder(URL, medicVedioExamRestClient.TOKEN).post(Entity.entity(medicVedioExam, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
