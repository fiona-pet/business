 ...
 */
public class PersonsAppointmentRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PersonsAppointmentRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/personsappointments";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PersonsAppointment>> result = (RestResult<List<PersonsAppointment>>)restResult;
                ...
                LOGGER.info("PersonsAppointment list:{}", JSON.toJSON(restResult));
            }
        }, URL, PersonsAppointmentRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final PersonsAppointment personsAppointment = new PersonsAppointment();
////        personsAppointment.set*("*");
//
//        Response response = getBuilder(URL, personsAppointmentRestClient.TOKEN).post(Entity.entity(personsAppointment, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
