 ...
 */
public class PersonsCmAppRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PersonsCmAppRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/personscmapps";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PersonsCmApp>> result = (RestResult<List<PersonsCmApp>>)restResult;
                ...
                LOGGER.info("PersonsCmApp list:{}", JSON.toJSON(restResult));
            }
        }, URL, PersonsCmAppRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final PersonsCmApp personsCmApp = new PersonsCmApp();
////        personsCmApp.set*("*");
//
//        Response response = getBuilder(URL, personsCmAppRestClient.TOKEN).post(Entity.entity(personsCmApp, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
