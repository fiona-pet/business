 ...
 */
public class PersonsRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PersonsRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/personss";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Persons>> result = (RestResult<List<Persons>>)restResult;
                ...
                LOGGER.info("Persons list:{}", JSON.toJSON(restResult));
            }
        }, URL, PersonsRestClient.TOKEN);
    }
...
////        persons.set*("*");
//
//        Response response = getBuilder(URL, personsRestClient.TOKEN).post(Entity.entity(persons, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
