 ...
 */
public class PetSmallRaceRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PetSmallRaceRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/petsmallraces";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PetSmallRace>> result = (RestResult<List<PetSmallRace>>)restResult;
                ...
                LOGGER.info("PetSmallRace list:{}", JSON.toJSON(restResult));
            }
        }, URL, PetSmallRaceRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final PetSmallRace petSmallRace = new PetSmallRace();
////        petSmallRace.set*("*");
//
//        Response response = getBuilder(URL, petSmallRaceRestClient.TOKEN).post(Entity.entity(petSmallRace, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
