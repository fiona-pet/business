 ...
 */
public class PrepayMoneyRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PrepayMoneyRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/prepaymoneys";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PrepayMoney>> result = (RestResult<List<PrepayMoney>>)restResult;
                ...
                LOGGER.info("PrepayMoney list:{}", JSON.toJSON(restResult));
            }
        }, URL, PrepayMoneyRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final PrepayMoney prepayMoney = new PrepayMoney();
////        prepayMoney.set*("*");
//
//        Response response = getBuilder(URL, prepayMoneyRestClient.TOKEN).post(Entity.entity(prepayMoney, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
