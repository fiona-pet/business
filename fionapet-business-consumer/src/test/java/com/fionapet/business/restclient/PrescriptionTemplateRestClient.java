 ...
 */
public class PrescriptionTemplateRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PrescriptionTemplateRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/prescriptiontemplates";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PrescriptionTemplate>> result = (RestResult<List<PrescriptionTemplate>>)restResult;
                ...
                LOGGER.info("PrescriptionTemplate list:{}", JSON.toJSON(restResult));
            }
        }, URL, PrescriptionTemplateRestClient.TOKEN);
    }
...
////        prescriptionTemplate.set*("*");
//
//        Response response = getBuilder(URL, prescriptionTemplateRestClient.TOKEN).post(Entity.entity(prescriptionTemplate, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
