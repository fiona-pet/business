 ...
 */
public class PrescriptionTemplateTypeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PrescriptionTemplateTypeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/prescriptiontemplatetypes";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<PrescriptionTemplateType>> result = (RestResult<List<PrescriptionTemplateType>>)restResult;
                ...
                LOGGER.info("PrescriptionTemplateType list:{}", JSON.toJSON(restResult));
            }
        }, URL, PrescriptionTemplateTypeRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final PrescriptionTemplateType prescriptionTemplateType = new PrescriptionTemplateType();
////        prescriptionTemplateType.set*("*");
//
//        Response response = getBuilder(URL, prescriptionTemplateTypeRestClient.TOKEN).post(Entity.entity(prescriptionTemplateType, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
