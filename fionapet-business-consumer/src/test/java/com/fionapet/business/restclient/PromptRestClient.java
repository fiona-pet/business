 ...
 */
public class PromptRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(PromptRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/prompts";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Prompt>> result = (RestResult<List<Prompt>>)restResult;
                ...
                LOGGER.info("Prompt list:{}", JSON.toJSON(restResult));
            }
        }, URL, PromptRestClient.TOKEN);
    }
...
////        prompt.set*("*");
//
//        Response response = getBuilder(URL, promptRestClient.TOKEN).post(Entity.entity(prompt, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
