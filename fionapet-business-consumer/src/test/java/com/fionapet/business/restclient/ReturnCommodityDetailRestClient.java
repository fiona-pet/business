 ...
 */
public class ReturnCommodityDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ReturnCommodityDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/returncommoditydetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ReturnCommodityDetail>> result = (RestResult<List<ReturnCommodityDetail>>)restResult;
                ...
                LOGGER.info("ReturnCommodityDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, ReturnCommodityDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final ReturnCommodityDetail returnCommodityDetail = new ReturnCommodityDetail();
////        returnCommodityDetail.set*("*");
//
//        Response response = getBuilder(URL, returnCommodityDetailRestClient.TOKEN).post(Entity.entity(returnCommodityDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
