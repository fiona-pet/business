 ...
 */
public class RewardPointLogRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(RewardPointLogRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/rewardpointlogs";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<RewardPointLog>> result = (RestResult<List<RewardPointLog>>)restResult;
                ...
                LOGGER.info("RewardPointLog list:{}", JSON.toJSON(restResult));
            }
        }, URL, RewardPointLogRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final RewardPointLog rewardPointLog = new RewardPointLog();
////        rewardPointLog.set*("*");
//
//        Response response = getBuilder(URL, rewardPointLogRestClient.TOKEN).post(Entity.entity(rewardPointLog, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
