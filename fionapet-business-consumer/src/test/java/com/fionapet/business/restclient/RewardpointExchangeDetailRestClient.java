 ...
 */
public class RewardpointExchangeDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(RewardpointExchangeDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/rewardpointexchangedetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<RewardpointExchangeDetail>> result = (RestResult<List<RewardpointExchangeDetail>>)restResult;
                ...
                LOGGER.info("RewardpointExchangeDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, RewardpointExchangeDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final RewardpointExchangeDetail rewardpointExchangeDetail = new RewardpointExchangeDetail();
////        rewardpointExchangeDetail.set*("*");
//
//        Response response = getBuilder(URL, rewardpointExchangeDetailRestClient.TOKEN).post(Entity.entity(rewardpointExchangeDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
