 ...
 */
public class RewardpointExchangeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(RewardpointExchangeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/rewardpointexchanges";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<RewardpointExchange>> result = (RestResult<List<RewardpointExchange>>)restResult;
                ...
                LOGGER.info("RewardpointExchange list:{}", JSON.toJSON(restResult));
            }
        }, URL, RewardpointExchangeRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final RewardpointExchange rewardpointExchange = new RewardpointExchange();
////        rewardpointExchange.set*("*");
//
//        Response response = getBuilder(URL, rewardpointExchangeRestClient.TOKEN).post(Entity.entity(rewardpointExchange, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
