 ...
 */
public class ServiceDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ServiceDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/servicedetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<ServiceDetail>> result = (RestResult<List<ServiceDetail>>)restResult;
                ...
                LOGGER.info("ServiceDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, ServiceDetailRestClient.TOKEN);
    }
...
////        serviceDetail.set*("*");
//
//        Response response = getBuilder(URL, serviceDetailRestClient.TOKEN).post(Entity.entity(serviceDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
