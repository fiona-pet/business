 ...
 */
public class ServiceRestClient extends RestClientTestCase {
    ...
    private static final String URL = "http://localhost:8818/api/v2/services";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Service>> result = (RestResult<List<Service>>)restResult;
                ...
                LOGGER.info("Service list:{}", JSON.toJSON(restResult));
            }
        }, URL, ServiceRestClient.TOKEN);
    }
...
////        service.set*("*");
//
//        Response response = getBuilder(URL, serviceRestClient.TOKEN).post(Entity.entity(service, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
