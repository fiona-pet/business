 ...
 */
public class StoreDirectSellDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(StoreDirectSellDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/storedirectselldetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<StoreDirectSellDetail>> result = (RestResult<List<StoreDirectSellDetail>>)restResult;
                ...
                LOGGER.info("StoreDirectSellDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, StoreDirectSellDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final StoreDirectSellDetail storeDirectSellDetail = new StoreDirectSellDetail();
////        storeDirectSellDetail.set*("*");
//
//        Response response = getBuilder(URL, storeDirectSellDetailRestClient.TOKEN).post(Entity.entity(storeDirectSellDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
