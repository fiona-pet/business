 ...
 */
public class StoreDirectSellRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(StoreDirectSellRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/storedirectsells";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<StoreDirectSell>> result = (RestResult<List<StoreDirectSell>>)restResult;
                ...
                LOGGER.info("StoreDirectSell list:{}", JSON.toJSON(restResult));
            }
        }, URL, StoreDirectSellRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final StoreDirectSell storeDirectSell = new StoreDirectSell();
////        storeDirectSell.set*("*");
//
//        Response response = getBuilder(URL, storeDirectSellRestClient.TOKEN).post(Entity.entity(storeDirectSell, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
