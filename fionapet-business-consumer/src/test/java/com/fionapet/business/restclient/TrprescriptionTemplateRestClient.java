 ...
 */
public class TrprescriptionTemplateRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(TrprescriptionTemplateRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/trprescriptiontemplates";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<TrprescriptionTemplate>> result = (RestResult<List<TrprescriptionTemplate>>)restResult;
                ...
                LOGGER.info("TrprescriptionTemplate list:{}", JSON.toJSON(restResult));
            }
        }, URL, TrprescriptionTemplateRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final TrprescriptionTemplate trprescriptionTemplate = new TrprescriptionTemplate();
////        trprescriptionTemplate.set*("*");
//
//        Response response = getBuilder(URL, trprescriptionTemplateRestClient.TOKEN).post(Entity.entity(trprescriptionTemplate, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
