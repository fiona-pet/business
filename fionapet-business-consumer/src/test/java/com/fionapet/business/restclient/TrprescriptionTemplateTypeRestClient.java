 ...
 */
public class TrprescriptionTemplateTypeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(TrprescriptionTemplateTypeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/trprescriptiontemplatetypes";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<TrprescriptionTemplateType>> result = (RestResult<List<TrprescriptionTemplateType>>)restResult;
                ...
                LOGGER.info("TrprescriptionTemplateType list:{}", JSON.toJSON(restResult));
            }
        }, URL, TrprescriptionTemplateTypeRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final TrprescriptionTemplateType trprescriptionTemplateType = new TrprescriptionTemplateType();
////        trprescriptionTemplateType.set*("*");
//
//        Response response = getBuilder(URL, trprescriptionTemplateTypeRestClient.TOKEN).post(Entity.entity(trprescriptionTemplateType, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
