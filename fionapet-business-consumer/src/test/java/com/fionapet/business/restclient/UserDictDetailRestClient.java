 ...
 */
public class UserDictDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserDictDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/userdictdetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<UserDictDetail>> result = (RestResult<List<UserDictDetail>>)restResult;
                ...
                LOGGER.info("UserDictDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, UserDictDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final UserDictDetail userDictDetail = new UserDictDetail();
////        userDictDetail.set*("*");
//
//        Response response = getBuilder(URL, userDictDetailRestClient.TOKEN).post(Entity.entity(userDictDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
