 ...
 */
public class VipInputTemRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(VipInputTemRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/vipinputtems";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<VipInputTem>> result = (RestResult<List<VipInputTem>>)restResult;
                ...
                LOGGER.info("VipInputTem list:{}", JSON.toJSON(restResult));
            }
        }, URL, VipInputTemRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final VipInputTem vipInputTem = new VipInputTem();
////        vipInputTem.set*("*");
//
//        Response response = getBuilder(URL, vipInputTemRestClient.TOKEN).post(Entity.entity(vipInputTem, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
