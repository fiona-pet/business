 ...
 */
public class WarehouseBackrecordDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseBackrecordDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/warehousebackrecorddetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<WarehouseBackrecordDetail>> result = (RestResult<List<WarehouseBackrecordDetail>>)restResult;
                ...
                LOGGER.info("WarehouseBackrecordDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseBackrecordDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final WarehouseBackrecordDetail warehouseBackrecordDetail = new WarehouseBackrecordDetail();
////        warehouseBackrecordDetail.set*("*");
//
//        Response response = getBuilder(URL, warehouseBackrecordDetailRestClient.TOKEN).post(Entity.entity(warehouseBackrecordDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
