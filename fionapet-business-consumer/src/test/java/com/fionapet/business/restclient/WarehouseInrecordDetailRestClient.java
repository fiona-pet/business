 ...
 */
public class WarehouseInrecordDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseInrecordDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/warehouseinrecorddetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<WarehouseInrecordDetail>> result = (RestResult<List<WarehouseInrecordDetail>>)restResult;
                ...
                LOGGER.info("WarehouseInrecordDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseInrecordDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final WarehouseInrecordDetail warehouseInrecordDetail = new WarehouseInrecordDetail();
////        warehouseInrecordDetail.set*("*");
//
//        Response response = getBuilder(URL, warehouseInrecordDetailRestClient.TOKEN).post(Entity.entity(warehouseInrecordDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
