 ...
 */
public class WarehouseMoverecordRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseMoverecordRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/warehousemoverecords";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<WarehouseMoverecord>> result = (RestResult<List<WarehouseMoverecord>>)restResult;
                ...
                LOGGER.info("WarehouseMoverecord list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseMoverecordRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final WarehouseMoverecord warehouseMoverecord = new WarehouseMoverecord();
////        warehouseMoverecord.set*("*");
//
//        Response response = getBuilder(URL, warehouseMoverecordRestClient.TOKEN).post(Entity.entity(warehouseMoverecord, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
