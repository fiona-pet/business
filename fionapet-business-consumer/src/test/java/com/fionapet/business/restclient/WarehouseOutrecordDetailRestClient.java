 ...
 */
public class WarehouseOutrecordDetailRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseOutrecordDetailRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/warehouseoutrecorddetails";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<WarehouseOutrecordDetail>> result = (RestResult<List<WarehouseOutrecordDetail>>)restResult;
                ...
                LOGGER.info("WarehouseOutrecordDetail list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseOutrecordDetailRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final WarehouseOutrecordDetail warehouseOutrecordDetail = new WarehouseOutrecordDetail();
////        warehouseOutrecordDetail.set*("*");
//
//        Response response = getBuilder(URL, warehouseOutrecordDetailRestClient.TOKEN).post(Entity.entity(warehouseOutrecordDetail, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
