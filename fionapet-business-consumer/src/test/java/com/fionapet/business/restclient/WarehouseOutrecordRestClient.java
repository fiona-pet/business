 ...
 */
public class WarehouseOutrecordRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseOutrecordRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/warehouseoutrecords";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<WarehouseOutrecord>> result = (RestResult<List<WarehouseOutrecord>>)restResult;
                ...
                LOGGER.info("WarehouseOutrecord list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseOutrecordRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final WarehouseOutrecord warehouseOutrecord = new WarehouseOutrecord();
////        warehouseOutrecord.set*("*");
//
//        Response response = getBuilder(URL, warehouseOutrecordRestClient.TOKEN).post(Entity.entity(warehouseOutrecord, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
