 ...
 */
public class WarehouseRestClient extends RestClientTestCase {
    ...
    private static final String URL = "http://localhost:8818/api/v2/warehouses";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Warehouse>> result = (RestResult<List<Warehouse>>)restResult;
                ...
                LOGGER.info("Warehouse list:{}", JSON.toJSON(restResult));
            }
        }, URL, WarehouseRestClient.TOKEN);
    }
...
////        warehouse.set*("*");
//
//        Response response = getBuilder(URL, warehouseRestClient.TOKEN).post(Entity.entity(warehouse, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
